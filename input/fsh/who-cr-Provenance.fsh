...
* include http://hl7.org/fhir/ValueSet/questionnaire-answers-status#completed
* include http://hl7.org/fhir/ValueSet/questionnaire-answers-status#amended
* include http://hl7.org/fhir/ValueSet/questionnaire-answers-status#stopped
...
* subject = Reference(WhoCrPatient) 